		...
		function getData() {
			...
			var request = $.ajax({
				...
				success : function(data) {
					...
					var timetime = new Date().toLocaleTimeString();
					context.fillStyle = "#D3D3D3";
					context.font = "normal 2px Serif";
					context.textBaseline = 'middle';
					context.fillText("Generated By cr At "+datetime+" "+timetime, 60, 780);
